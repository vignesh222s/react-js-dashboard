...
const { getFieldDecorator } = this.props.form;
    return (
        ...
        >
   {this.state.visible?  <Test name="PRODUCT CATEGORY" id="Product Category Name:" ph="Enter Product Category Name"
   lid="Category Icon:" msg=" product category name!" modal={this.handleCancel}/>:null}
