...
const { getFieldDecorator } = this.props.form;
    return (
        ...
        {this.state.visible?<Test name="BRAND" id="Brand Category Name:" ph="Enter Product Brand Name" lid="Brand Icon:" lid="Category Icon:" msg=" brand category name!" modal={this.handleCancel}/>:null}
        </Modal>
